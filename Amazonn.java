class Amazonn{
  ...
  // if(isFirstNameValid==true && isLastNameValid==true && ==true && isDobValid==true && isEmailValid==true && isPasswordValid==true &&  isConfirmPasswordValid= true && isContactNumberValid = true)
