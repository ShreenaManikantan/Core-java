class SuperMarket{
  ...
  String dairyproduct[] = {"Butter","yogart","cheese","whipped cream","custard","ghee","sourcreem","margarine","feta","curd","kefir","buttermilk","skyr","milk shakes","lassi"};
  String spices[] = {"Termeric","cinnomon"," bay leaf"," Tamiarind","Cardamon","Nutmeg","Clove","Musterd seed","black papper"," anise","Thyme","Cumin seed","fennelcarmon","carom seed","Licorice"};
	...
	System.out.println("List of dairyproduct are:" + dairyproduct[0] +"\n"+ dairyproduct[1] +"\n"+ dairyproduct[2] +"\n"+ dairyproduct[3] +"\n"+ dairyproduct[4] +"\n"+ dairyproduct[5] +"\n"+ dairyproduct[6] +"\n"+ dairyproduct[7] +"\n"+ dairyproduct[8] +"\n"+ dairyproduct[9] +"\n"+ dairyproduct[10] +"\n"+ dairyproduct[11] +"\n"+ dairyproduct[12] +"\n"+ dairyproduct[13] +"\n"+ dairyproduct[14]);
