class Xworkz{
  ...
  if(firstName!= null){
   ...
   //if ( isFirstNameValid==true && isLastNameValid==true && isMailidValid==true && isDateOfBirthValid==true && isBePercentageValid==true && isBranchValid==true && isSslcPerValid==true  && ==true) 
