class Linkedln{
  ...
  isRoleValid = true;
   ...
   isYearofPassValid= true;
	...
	//if(isFirstNameValid==true && isLastNameValid==true && isEmailidValid==true && isPasswordValid==true && isConformPasswordValid==true && isCountryValid==true && isPincodeValid==true &&  isCompanyValid==true &&  isRoleValid==true &&  isIndustryValid==true &&  isEducationValid==true)
